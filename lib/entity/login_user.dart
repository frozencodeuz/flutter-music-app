class LoginUser {
  ...
  LoginUser({this.loginType, this.code, this.account, this.profile, this.bindings});
...
//  Null remarkName;
  ...
  Profile({this.nickname, this.accountStatus, this.vipType, this.gender, this.province, this.defaultAvatar, this.avatarUrl, this.birthday, this.city, this.userId,
//    this.expertTags,
    this.experts, this.djStatus, this.avatarImgId, this.backgroundImgId, this.userType, this.mutual,
//    this.remarkName,
    this.authStatus, this.detailDescription, this.followed, this.backgroundUrl, this.avatarImgIdStr, this.backgroundImgIdStr, this.description, this.signature, this.authority, this.followeds, this.follows, this.eventCount, this.playlistCount, this.playlistBeSubscribedCount});
