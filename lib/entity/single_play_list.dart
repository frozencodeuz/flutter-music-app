class PlaylistDetail {
  ...
  PlaylistDetail({this.privileges, this.code, this.playlist});
...
//    this.trackIds,
    this.id, this.ordered, this.creator,
//    this.subscribers,
...
class TrackId {
  ...
  TrackId({this.v, this.id, this.alg});
...
//  List<Null> alia;
  ...
  PlaylistDetailPlaylistTrack({this.no, this.rt, this.copyright, this.fee, this.rurl, this.mst, this.pst, this.pop, this.dt, this.rtype, this.sId,
//    this.rtUrls,
    this.id, this.st, this.a, this.cd, this.publishTime, this.cf, this.h, this.mv, this.al, this.l, this.m, this.cp,
//    this.alia,
    this.djId, this.crbt, this.ar, this.rtUrl, this.ftype, this.t, this.v, this.name, this.tns, this.mark});
...
//  List<Null> tns;
  ...
  PlaylistDetailPlaylistTracksAl({this.picUrl, this.name,
//    this.tns,
...
//  List<Null> alias;
  ...
  PlaylistDetailPlaylistTracksAr({this.name,
//    this.tns, this.alias,
    this.id});
